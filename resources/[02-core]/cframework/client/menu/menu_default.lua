Citizen.CreateThread(function()
	...
	Citizen.CreateThread(function()
		while true do
			...
			if IsControlPressed(0, Keys['TOP']) and GetLastInputMethod(2) and (GetGameTimer() - GUI.Time) > 120 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'TOP'
				})
			...
			if IsControlPressed(0, Keys['DOWN']) and GetLastInputMethod(2) and (GetGameTimer() - GUI.Time) > 120 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'DOWN'
				})
