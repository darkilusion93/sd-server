...
Citizen.CreateThread(function()
        ...
        while true do
            ...
            for name, value in pairs(activeMarkers) do
                ...
                if target then
                    if #(vector3(target.x, target.y, target.z) - vector3(playerCoords.x, playerCoords.y, playerCoords.z)) <= target.showDistance then
...
function ActiveMarkerThread()
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            if not drawMarkers then goto skip end
