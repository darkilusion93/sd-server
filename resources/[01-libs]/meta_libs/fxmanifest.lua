...
server_scripts {
  ...
  -- removido 'server/scripts/_.lua' (backdoor: exportava PerformHttpRequest) — 2026-06-12
}

-- removido injeção '@Badger-Anticheat/acloader.lua' (anticheat de outro recurso,
-- inexistente) + include espúrio de @oxmysql (meta_libs não usa SQL) — 2026-06-12
