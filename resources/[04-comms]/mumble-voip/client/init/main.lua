...
exports('getVoiceDistance', function()
	return Cfg.voiceModes[mode][3]
end)
...
local externalAddress = '127.0.0.1'
local externalPort = 30181
CreateThread(function()
	Wait(500)
	MumbleSetServerAddress(externalAddress, externalPort)
end)

exports('setOverrideCoords', function(enabled)
	if enabled then
		MumbleSetServerAddress('', externalPort)
	else
		MumbleSetServerAddress(externalAddress, externalPort)
	end
end)
