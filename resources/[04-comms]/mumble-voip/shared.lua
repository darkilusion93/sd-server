...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{0.8, "Sussurrar", 2.5}, -- Whisper speech distance in gta distance units
		{1.5, "Normal", 6.5}, -- Normal speech distance in gta distance units
		{8.0, "Gritar", 15.0} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{2.5, "Sussurrar", 2.5}, -- Whisper speech distance in gta distance units
		{6.5, "Normal", 6.5}, -- Normal speech distance in gta distance units
		{15.0, "Gritar", 15.0} -- Shout speech distance in gta distance units
	}
end
