...
Config.RestrictedChannels = 359 -- channels that are encrypted (EMS, Fire and police can be included there) if we give eg 10, channels from 1 - 10 will be encrypted
...
Config.messages = {
  ...
  ['restricted_channel_error'] = 'Este canal está encriptado!',
  ['you_on_radio'] = 'Já estás na frequência: <b>',
