...
Config.golfConfig.DrawDistance               = 30.0
Config.golfConfig.MarkerType                 = 1
Config.golfConfig.MarkerSize                 = { x = 2.5, y = 2.5, z = 1.0 }
Config.golfConfig.MarkerColor                = { r = 50, g = 50, b = 204 }

Config.golfConfig.EnablePlayerManagement     = true
Config.golfConfig.EnableArmoryManagement     = true
Config.golfConfig.EnableESXIdentity          = true -- enable if you're using esx_identity
Config.golfConfig.EnableNonFreemodePeds      = false -- turn this on if you want custom peds
Config.golfConfig.EnableSocietyOwnedVehicles = true
Config.golfConfig.EnableLicenses             = false -- enable if you're using esx_license

Config.golfConfig.EnableHandcuffTimer        = true -- enable handcuff timer? will unrestrain player after the time ends
Config.golfConfig.HandcuffTimer              = 60 * 60000 -- 10 mins

Config.golfConfig.EnableJobBlip              = false -- enable blips for colleagues, requires esx_society

Config.golfConfig.MaxInService               = -1
Config.golfConfig.Locale                     = 'br'

Config.golfConfig.Stations = {
  ...
  pearl = {
    ...
    AuthorizedWeapons = {
		...
		Cloakrooms = {
			{ x = -1835.72, y = -1179.32, z = 13.33 },
		},

    Armories = {
      { x = -1839.84, y = -1189.66, z = 13.32 },
    },

		Vehicles = {
			{
				Spawner    = { x = -1854.51, y = -1192.34, z = 12.02 },
				SpawnPoints = {
		...
		VehicleDeleters = {
			{x = -1857.86, y = -1197.11, z = 12.02 },
		},

		BossActions = {
			{x = -1836.29, y = -1176.59, z = 18.19 },
		},
	},
    cafe = {
    ...
    AuthorizedWeapons = {
		...
		Cloakrooms = {
			{ x = -634.71, y = 226.36, z = 80.88 },
			{ x = 963.83, y = 26.35, z = 70.46 },
		},
	
    Armories = {
		{ x = -631.9, y = 227.65, z = 80.88 },
    },
	
		Vehicles = {
			{
				Spawner    = { x = -613.46, y = 207.21, z = 73.18 },
				SpawnPoints = {
					{x = -627.38, y = 207.03, z = 73.20, heading = 100.24, radius = 4.0 },
				},
			},
		},
		...
		VehicleDeleters = {
			{x = -612.23, y = 198.88, z = 70.06 },
		},
	
		BossActions = {
			{x = -621.12, y = 235.04, z = 80.88 },
		},
		
	},
}

Config.golfConfig.AuthorizedVehicles = {
	Shared = {
	},
