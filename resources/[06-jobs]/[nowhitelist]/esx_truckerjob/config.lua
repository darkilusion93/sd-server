...
Config.Trailer = "trailers2" -- ONLY 1 TRAILER
...
Config.VehicleSpawnPoint0 = {
      Pos   = {x = 191.73, y = 2799.62, z = 45.87},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}

Config.VehicleSpawnPoint1 = {
      Pos   = {x = 174.73, y = 2750.6, z = 42.43},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}

Config.VehicleSpawnPoint2 = {
      Pos   = {x = 200.63, y = 2746.7, z = 42.43},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}

Config.VehicleSpawnPoint3 = {
      Pos   = {x = 193.68, y = 2706.69, z = 41.46},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}
...
--The trailer spawns here, make sure it doesn't collide with the trailer
Config.TrailerSpawnPoint1 = {
      Pos   = {x = 169.25, y = 2754.16, z = 42.41},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}

Config.TrailerSpawnPoint2 = {
      Pos   = {x = 211.04, y = 2755.91, z = 43.43},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}

--The trailer spawns here, make sure it doesn't collide with the trailer
Config.TrailerSpawnPoint3 = {
      Pos   = {x = 183.05, y = 2719.67, z = 41.16},
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}
