  ...
  function Start(ped)
	  ...
	  while checking do
		  ...
		  if PlayerData.job.name == 'ambulance' then
			  ...
			  DrawText3D(x,y,z, 'Pressione ~r~E~w~ para Verificar Gravidade Ferimentos', 0.4)
...
RegisterNetEvent('TxDEV:morte')
AddEventHandler('TxDEV:morte', function(ped)
	OpenDeathMenu(ped)
end)
  ...
  function Notification(x,y,z)
	  ...
	  while (timestamp + 4500) > GetGameTimer() do
		  Citizen.Wait(0)
		  DrawText3D(x, y, z, 'Os danos parecem ocorrer daqui', 0.4)
		  checking = false
	  end
  end
	  ...
	  function(data, menu)
		  ...
		  if ac == 'damage' then
			  ...
			  if success then
				  ...
				  Notify('Não foi possível identificar o local onde ocorreram os danos')
			  end
		  end
