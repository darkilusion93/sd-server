                ...
                if IsPlayerFreeAiming(playerid) and GetSelectedPedWeapon(playerPed) == GetHashKey("WEAPON_FLASHLIGHT") then
                    ...
                    for t, s in pairs(blood) do
                        ...
                        if GetDistanceBetweenCoords(s.coords, GetEntityCoords(playerPed)) < 1 then
                            if ((job == 'police' or job == 'sheriff' or job == 'state') and allowed == true) or job == 'pj' or job == 'siis' then
                                DrawText3D(
                                    s.coords[1],
                                    s.coords[2],
                                    s.coords[3] - 0.65,
...
Citizen.CreateThread(function()
    while true do
        ...
        if ((job == 'police' or job == 'sheriff' or job == 'state') and allowed == true) or job == 'pj' or job == 'siis' then
            ...
            local aleatorio = math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9) .. math.random(0, 9)
            
            if GetDistanceBetweenCoords(coords, Config.EvidenceStorageLocation, true) < 1.5 then
                DrawText3D(
                ...
                if IsControlJustReleased(0, 38) then
                    ESX.TriggerServerCallback("core_evidence:getStorageData", function(data)
                        ESX.UI.Menu.CloseAll()

                        local elements = {}

                        for _, v in ipairs(data) do
                            table.insert(elements, {label = Config.Text["report_list"] .. v.id, value = v.data, id = v.id})
                        end
            ...
            elseif GetDistanceBetweenCoords(coords, Config.EvidenceStorageLocation2, true) < 1.5 then
                DrawText3D(
                    Config.EvidenceStorageLocation2[1],
                    Config.EvidenceStorageLocation2[2],
                    Config.EvidenceStorageLocation2[3],
                    Config.Text["open_evidence_archive"]
                )
            ...
            elseif GetDistanceBetweenCoords(coords, Config.EvidenceAlanysisLocation, true) < 1.5 then
