...
Config.taxRate = 1.00  --65% of the dirty you will get back in clean
...
Config.timer = 30 * second -- Time it takes to wash money. The * amount will determine if its hours, second, or minutes.
