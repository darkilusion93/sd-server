...
window.addEventListener('message', function(event) {
	switch (event.data.action) {
		case 'openContractSeller':
			...
			$("#price2").html(event.data.price2);
			$("#price3").html(event.data.price3);
			...
			price2 = event.data.price2;
			price3 = event.data.price3;
		...
		case 'openContractOnBuyer':
			...
			vehicle_price2 = event.data.price2;
			vehicle_price3 = event.data.price3;
