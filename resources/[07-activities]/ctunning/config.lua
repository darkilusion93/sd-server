...
function GetColors() 
	...
	local menu = {
		...
		subMenu = {
            ...
            {
                type = json.encode({tipo = "chameleon-color"}),
                title = "Camaleão",
                src = "img/color.png",
                subSubMenuSelected = 99,
                subSubMenuTitle = Config.Translations["change"].." "..Config.Translations["primecolor"],
    ...
    for i=161, 242 do
        menu.subMenu[3].subSubMenu[#menu.subMenu[3].subSubMenu+1] = {
            type = json.encode({tipo = "corspecial",index = i}),
            title = "Camaleão "..i-160,
            src = "img/pearlescent.png",
        }
    end
...
function Stance()
    local default = {}
    default.wheelWidth = GetVehicleWheelWidth(carroselected)
    default.frontTrackWidth = GetVehicleWheelXOffset(carroselected, 1)*2
    default.backTrackWidth = GetVehicleWheelXOffset(carroselected, 3)*2
    default.frontTrackRotation = GetVehicleWheelYRotation(carroselected, 0)
    default.backTrackRotation = GetVehicleWheelYRotation(carroselected, 2)
	...
	local menu = {
		type = json.encode({tipo = "Stance"}),
		title = Config.Translations["stance"],
		src = "img/suspension.png",
		subMenuTitle = Config.Translations["change"].." "..Config.Translations["stance"],
		subMenuSelected = 99,
		subMenu = {
			{
				type = json.encode({tipo = "stance", index = 1}),
                slider = true,
				title = "Front Width",
				src = "img/suspension.png",
                min = 1.3,
                max = 2.3,
                default = default.frontTrackWidth,
                name = "frontTrackWidth",
			},
            {
				type = json.encode({tipo = "stance", index = 2}),
                slider = true,
				title = "Back Width",
				src = "img/suspension.png",
                min = 1.3,
                max = 2.3,
                default = default.backTrackWidth,
                name = "backTrackWidth",
			},
            {
				type = json.encode({tipo = "stance", index = 3}),
                slider = true,
				title = "Front Rotation",
				src = "img/suspension.png",
                min = -0.2,
                max = 0.1,
                default = default.frontTrackRotation,
                name = "frontTrackRotation",
			},
            {
				type = json.encode({tipo = "stance", index = 4}),
                slider = true,
				title = "Back Rotation",
				src = "img/suspension.png",
                min = -0.2,
                max = 0.1,
                default = default.backTrackRotation,
                name = "backTrackRotation",
			},
            {
				type = json.encode({tipo = "stance", index = 5}),
                slider = true,
				title = "Tire Width",
				src = "img/suspension.png",
                min = 0.5,
                max = 0.9,
                default = default.wheelWidth,
                name = "wheelWidth",
			},
            --[[{
				type = json.encode({tipo = "xcolor"}),
