...
ActivePosters = {}
CurrentPoster = {}
GLOBAL_COORDS = vector3(0.0, 0.0, 0.0)
TXD = nil 
PlayerData = {}
local Framework
...
RegisterNetEvent("posters:sendAddedImage", function(newImage)
    newImage.pointA = vector3(newImage.pointA.x, newImage.pointA.y, newImage.pointA.z)
    newImage.pointB = vector3(newImage.pointB.x, newImage.pointB.y, newImage.pointB.z)
    DUILoaded = false
