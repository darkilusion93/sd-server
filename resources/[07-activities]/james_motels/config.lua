...
Config.MotelPrice = 30000 -- this is the price that you will pay when you buy the motel.
Config.KeyPrice = 1000 -- this is the price for each key that you want to buy.

Config.StorageWeight = 5000 -- Maximum weight for storage
...
Config.MotelInterior = {
    ...
    ["storage"] = vector3(151.2246, -1003.2491, -98.9999),
}
...
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_REPLAY_SCREENSHOT~ Colocar no chão ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_SPRINT~ Velocidade ~n~" 
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_ENTER~ Abrir Menu Itens ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_DETONATE~ Guardar ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_VEH_DUCK~ Apagar Item~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_PAUSE~ Fechar Menu~n~"

local function initRandomSeed()
    local seed = os and os.time() or GetGameTimer()
