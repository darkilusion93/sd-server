...
RPC.register("EntrarMotel", function()
    local _source = source

    SetPlayerRoutingBucket(_source, tonumber(_source))
    SetRoutingBucketPopulationEnabled(tonumber(_source), false)
end)
RPC.register("SairMotel", function()
    local _source = source
