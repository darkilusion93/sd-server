...
CreateMenu = function(data, showSearchBar)
    local searchbar = showSearchBar or false
...
RegisterNetEvent("nh-context:createMenu", function(data, showSearchBar)
